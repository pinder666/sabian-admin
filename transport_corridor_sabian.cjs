// transport_corridor_sabian.cjs
// 🚛 SABIAN CORE INTEL THREAD — TRANSPORT INFRASTRUCTURE (SADC & UAE)
...
const AGENT_ID = 'transport_corridor_sabian';
...
const CONFIG = {
  ...
  sources: [
    {
      name: 'UAE Ministry of Transport News',
      url: 'https://www.mot.gov.ae/en/media.center/news.aspx',
      selector: '.newsItem',
      region: 'UAE',
      tags: ['transport', 'infrastructure', 'uae']
    },
    {
      name: 'SADC Infrastructure Hub',
      url: 'https://www.sadc.int/themes/infrastructure/',
      selector: '.block-content',
      region: 'SADC',
      tags: ['transport', 'corridors', 'sadc']
    },
    {
      name: 'Africa Transport Policy Program',
      url: 'https://www.ssatp.org/news',
      selector: '.views-row',
      region: 'Africa',
      tags: ['mobility', 'corridor', 'projects']
    }
  ]
};
