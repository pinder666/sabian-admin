// urban_signal_sabian.cjs
// 🏙 SABIAN CORE INTEL THREAD — URBAN SMART CITY SIGNALS (UAE)
...
const AGENT_ID = 'urban_signal_sabian';
...
const CONFIG = {
  ...
  sources: [
    {
      name: 'Dubai Smart City News',
      url: 'https://www.smartdubai.ae/news',
      selector: '.card-body',
      region: 'UAE',
      tags: ['smartcity', 'dubai', 'urban']
    },
    {
      name: 'Abu Dhabi Smart Systems',
      url: 'https://www.adda.gov.ae/en/media-center/news',
      selector: '.media-item',
      region: 'UAE',
      tags: ['adda', 'urban', 'governance']
    }
  ]
};
