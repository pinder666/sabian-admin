// economic_sentinel_sabian.cjs
// 💹 SABIAN CORE INTEL THREAD — ECONOMIC SIGNAL MONITOR (UAE + SADC)
...
const AGENT_ID = 'economic_sentinel_sabian';
...
const CONFIG = {
  ...
  sources: [
    {
      name: 'UAE Central Bank News',
      url: 'https://www.centralbank.ae/en/media-news',
      selector: '.news-list',
      region: 'UAE',
      tags: ['economy', 'uae', 'banking']
    },
    {
      name: 'SADC Economic News (SADC.int)',
      url: 'https://www.sadc.int/news-events/news/',
      selector: '.block-content',
      region: 'SADC',
      tags: ['economy', 'africa', 'sadc']
    },
    {
      name: 'AfDB Markets News',
      url: 'https://www.afdb.org/en/news-and-events/markets',
      selector: '.views-row',
      region: 'Africa',
      tags: ['finance', 'markets', 'afdb']
    }
  ]
};
