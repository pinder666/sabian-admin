// security_signal_sabian.cjs
// 🚓 SABIAN CORE INTEL THREAD — LAW ENFORCEMENT + SECURITY MONITOR
...
const AGENT_ID = 'security_signal_sabian';
...
const CONFIG = {
  ...
  sources: [
    {
      name: 'UAE Ministry of Interior News',
      url: 'https://www.moi.gov.ae/en/media.center/news.aspx',
      selector: '.newsBox',
      region: 'UAE',
      tags: ['security', 'law', 'enforcement', 'uae']
    },
    {
      name: 'SADC Peace & Security Division',
      url: 'https://www.sadc.int/themes/politics-peace-security/news-events',
      selector: '.views-row',
      region: 'SADC',
      tags: ['policing', 'safety', 'regional']
    }
  ]
};
